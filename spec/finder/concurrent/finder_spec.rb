...
RSpec.describe Contrek::Concurrent::Finder, type: :class do
  ...
  it "3 workers one rectangle" do
    ...
    expect(result[:polygons]).to eq([{outer: [{x: 4, y: 1}, {x: 9, y: 1}, {x: 13, y: 1}, {x: 13, y: 6}, {x: 9, y: 6}, {x: 4, y: 6}, {x: 2, y: 6}, {x: 2, y: 1}], inner: [[{x: 4, y: 2}, {x: 3, y: 3}, {x: 3, y: 4}, {x: 4, y: 5}, {x: 12, y: 4}, {x: 12, y: 3}]]}])
  end
  ...
  it "circle with inside" do
    ...
    expect(result[:polygons]).to eq([{outer: [{x: 7, y: 0}, {x: 11, y: 0}, {x: 14, y: 3}, {x: 14, y: 6}, {x: 11, y: 9}, {x: 7, y: 9}, {x: 4, y: 9}, {x: 1, y: 6}, {x: 1, y: 3}, {x: 4, y: 0}], inner: [[{x: 4, y: 2}, {x: 3, y: 3}, {x: 3, y: 6}, {x: 4, y: 7}, {x: 7, y: 7}, {x: 7, y: 6}, {x: 8, y: 5}, {x: 8, y: 4}, {x: 7, y: 3}, {x: 7, y: 2}]]}])
  ...
  it "problematic shape" do
    ...
    expect(result[:polygons]).to eq([{outer: [{x: 7, y: 0}, {x: 7, y: 3}, {x: 5, y: 4}, {x: 2, y: 5}, {x: 1, y: 6}, {x: 1, y: 9}, {x: 2, y: 10}, {x: 7, y: 11}, {x: 12, y: 11}, {x: 14, y: 9}, {x: 14, y: 6}, {x: 13, y: 5}, {x: 13, y: 0}], inner: []}])
